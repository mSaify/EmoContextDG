...
from Model.EMPC_Disc import EmpC_Disc
...
if __name__ == '__main__':
    ...
    config.d_steps=1
    config.g_steps=5
    config.save_path='save/EmpDG_woD/'
    config.pointer_gen
    #config.emotion_disc=True
    ...
    if config.model == "EmpDG_woG":
        ...
        if config.test:
            ...
            model_d = EmpC_Disc(vocab)  # emotion_disc is False
